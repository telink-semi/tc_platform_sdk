...
spi_pin_config_t spi_pin_config = {
    .spi_csn_pin       = GPIO_PC7,
    .spi_clk_pin       = GPIO_PC6,
...
void main_loop (void)
{
...
#if(MCU_CORE_B85||MCU_CORE_B87||MCU_CORE_B89)
    ...
    cmd_buf[3]= SPI_READ_CMD;
    spi_read((unsigned char*)cmd_buf, CMD_BUF_LEN,(unsigned char*)spi_rx_buff, BUFF_DATA_LEN);
#endif
}
