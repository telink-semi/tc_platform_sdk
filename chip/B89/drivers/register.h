...
#define     reg_otp_offsetl     read_reg8(0x580+0x52)
enum{
	FLD_OTP_PADR_AUTO_INC       = BIT(0),
	FLD_OTP_PCE_AUTO_MODE       = BIT(1),
	FLD_OTP_PCE_TO_SEL          = BIT_RNG(2,3),
	FLD_OTP_PCE_TCS_SEL_MODE    = BIT(4),
	FLD_OTP_PCE_TCS_SEL         = BIT_RNG(5,7),
};
...
#define reg_gpio_func_mux(i)        REG_ADDR8(0x5a8+((i>>8)<<2)+((i&0xc0)?3:0)+((i&0x30)?2:0)+((i&0x0c)?1:0))

#define reg_mux_func_a1      		REG_ADDR8(0x5a8)
#define reg_mux_func_a2      		REG_ADDR8(0x5a9)
#define reg_mux_func_a3             REG_ADDR8(0x5aa)
#define reg_mux_func_a4             REG_ADDR8(0x5ab)

#define reg_mux_func_b1     		REG_ADDR8(0x5ac)
#define reg_mux_func_b2     		REG_ADDR8(0x5ad)
#define reg_mux_func_b3     		REG_ADDR8(0x5ae)
#define reg_mux_func_b4     		REG_ADDR8(0x5af)

#define reg_mux_func_c1     		REG_ADDR8(0x5b0)
#define reg_mux_func_c2     		REG_ADDR8(0x5b1)
#define reg_mux_func_c3     		REG_ADDR8(0x5b2)
#define reg_mux_func_c4     		REG_ADDR8(0x5b3)

#define reg_mux_func_d1     		REG_ADDR8(0x5b4)
#define reg_mux_func_d2     		REG_ADDR8(0x5b5)
#define reg_mux_func_d3     		REG_ADDR8(0x5b6)
#define reg_mux_func_d4     		REG_ADDR8(0x5b7)
...
#define reg_gpio_wakeup_irq  		REG_ADDR8(0x5d4)
enum{
...
//	RSVD				 =		BIT(3),
	...
	FLD_IRQ_MIX_CMD_EN =		BIT(7), FLD_IRQ_HOST_CMD_EN  =BIT(7),FLD_IRQ_QDEC_EN  =BIT(7),FLD_IRQ_SOFTWARE_EN =BIT(7),FLD_IRQ_IRLEARN_EN  =BIT(7),FLD_IRQ_STIMER_LEV_EN  =BIT(7),FLD_IRQ_IR_LEARN_EN =BIT(7),
