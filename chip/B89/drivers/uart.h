...
/**
 *  @brief  Define UART TX pin:A1 B0 B3 B4 B6 C0 D4
 */

typedef enum{
	UART_TX_PA1 = GPIO_PA1,
	UART_TX_PB0 = GPIO_PB0,
	UART_TX_PB3 = GPIO_PB3,
	UART_TX_PB4 = GPIO_PB4,
	UART_TX_PB6 = GPIO_PB6,
	UART_TX_PC0 = GPIO_PC0,
	UART_TX_PD4 = GPIO_PD4,
	UART_TX_NONE_PIN =0xfff,
}UART_TxPinDef;

/**
 *  @brief  Define UART RX pin: A0 A5 B0 B1 B3 B4 C0 C2 D3
 */
...
typedef enum{
	...
	UART_RX_PB1 = GPIO_PB1,
	UART_RX_PB3 = GPIO_PB3,
	UART_RX_PB4 = GPIO_PB4,
	UART_RX_PC0 = GPIO_PC0,
	UART_RX_PC2 = GPIO_PC2,
	UART_RX_PD3 = GPIO_PD3,
	UART_RX_NONE_PIN =0xfff,
}UART_RxPinDef;

/**
 *  @brief  Define UART RTX pin: B1 D3
 */
typedef enum{
...
/**
 *  @brief  Define UART CTS pin : A3 B3 B4 B6 C0 C2 D2
 */

typedef enum{
	UART_CTS_PA3 = GPIO_PA3,
	UART_CTS_PB3 = GPIO_PB3,
	UART_CTS_PB4 = GPIO_PB4,
	UART_CTS_PB6 = GPIO_PB6,
	UART_CTS_PC0 = GPIO_PC0,
	UART_CTS_PC2 = GPIO_PC2,
	UART_CTS_PD2 = GPIO_PD2,
}UART_CtsPinDef;

/**
 *  @brief  Define UART RTS pin : A2 B4 B5 C0 C2 D2 D3 D5
 */

typedef enum{
	UART_RTS_PA2 = GPIO_PA2,
	UART_RTS_PB4 = GPIO_PB4,
	UART_RTS_PB5 = GPIO_PB5,
	UART_RTS_PC0 = GPIO_PC0,
	UART_RTS_PC2 = GPIO_PC2,
	UART_RTS_PD2 = GPIO_PD2,
	UART_RTS_PD3 = GPIO_PD3,
	UART_RTS_PD5 = GPIO_PD5,
