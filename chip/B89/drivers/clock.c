...
void dmic_prob_32k(unsigned char src)
{
	...
	analog_write(0x2d, (analog_read(0x2d) & 0x7f) | (src << 7));

	write_reg8(0x70, read_reg8(0x70) | BIT(0));    						//r_sclk_sel[8]=1, clk_7816 sel clk_32k
	write_reg8(0x5ad, (read_reg8(0x5ad) & 0xf0) | (1 & 0x0f));  		//pb_fs[11:8]=1,  pb[2] sel clk_7816
	write_reg8(0x58e, read_reg8(0x58e) & ~(BIT(2)));
}
...
{
	//probe 24M/2 RC
	//PA[1] select dmic clk

	write_reg8(0x5a8, (read_reg8(0x5a8) & 0x0f) | (3<<4));
	write_reg8(0x586, read_reg8(0x586) & (~BIT(1)));
