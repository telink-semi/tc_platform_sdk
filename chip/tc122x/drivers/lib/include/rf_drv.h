...
typedef enum {
	...
	RF_POWER_P4p50dBm  = 23,    /**<  4.5 dbm */
	RF_POWER_P4p00dBm  = 22,    /**<  4.0 dbm */
	RF_POWER_P3p50dBm  = 21,    /**<  3.5 dbm */
	RF_POWER_P3p25dBm  = 20,    /**<  3.25 dbm */
	RF_POWER_P3p00dBm  = 19,    /**<  3.0 dbm */
	RF_POWER_P2p50dBm  = 18,    /**<  2.5 dbm */
	RF_POWER_P2p00dBm  = 17,    /**<  2.0 dbm */
	RF_POWER_P1p50dBm  = 16,    /**<  1.5 dbm */
	RF_POWER_P1p00dBm  = 15,    /**<  1.0 dbm */
	RF_POWER_P0p50dBm  = 14,    /**<  0.5 dbm */
	RF_POWER_P0p00dBm  = 13,    /**<  0.0 dbm */
	RF_POWER_N0p50dBm  = 12,    /**< -0.5 dbm */
	RF_POWER_N1p00dBm  = 11,    /**< -1.0 dbm */
 ...
 * @return  none.
 */
_attribute_ram_code_sec_noinline_ void rf_set_tx_rx_off(void);
#endif
