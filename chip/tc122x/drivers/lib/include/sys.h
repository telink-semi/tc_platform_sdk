...
extern _attribute_data_retention_ unsigned char g_retention_ldo_trim;
extern _attribute_data_retention_ unsigned char g_dig_ldo_top_capless;
extern _attribute_data_retention_ unsigned char g_reg_0x35;
 ...
 */
_attribute_ram_code_sec_noinline_ void cpu_wakeup_init(cap_typedef_e cap);
...
#if MIN_SYS
/**
 * @brief     This function serves to initial minimal system.
 * @param[in] none.
 * @return    none.
 */
void sys_init_min_sys(void);    //must on ramcode
#endif
