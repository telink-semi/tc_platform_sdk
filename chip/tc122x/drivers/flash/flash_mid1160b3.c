...
unsigned char flash_write_status_mid1160b3(unsigned char data, unsigned char mask)
{
	...
	unsigned char status = flash_read_status_mid1160b3();
	if(data != (status & mask))	//To reduce the operation of the status register.
	{
		...
		status = flash_read_status_mid1160b3();
	}
	if(data == (status & mask))
	{
		return 1;
...
{
	return flash_write_status_mid1160b3(data, FLASH_WRITE_STATUS_BP_MID1160B3);
}
...
{
	return flash_write_status_mid1160b3(FLASH_LOCK_NONE_MID1160B3, FLASH_WRITE_STATUS_BP_MID1160B3);
}
...
{
	return flash_read_status_mid1160b3()&FLASH_WRITE_STATUS_BP_MID1160B3;
}
...
{
	return flash_write_status_mid1160b3(data, FLASH_WRITE_STATUS_OTP_MID1160B3);
}
