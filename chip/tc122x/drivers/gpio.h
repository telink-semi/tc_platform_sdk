...
typedef enum
{
	...
	PWM4		=0,
	PWM5		=0,
	AS_SWIRE    =0,//UART_CTS_I=0,UART_RX_I=0, UART_TX=0, UART_RTS=0,
	AS_MSPI     =0,
	AS_GPIO     =0xff,
	...
	PWM3_N		=1,
	PWM4_N		=1,
	PWM5_N		=1,//PWM0=1,PWM1=1,PWM2=1,PWM3=1,
...
{
	write_reg8(0x509, read_reg8(0x509) | 0x78);
}
...
{
	 write_reg8(0x509, read_reg8(0x509) & ~0x78); //MSPI ie disable
}
