...
/**
 *  @brief  Define UART0 TX pin.
 */
typedef enum
{
    UART_TX_PA0      = GPIO_PA0,
    UART_TX_PA1      = GPIO_PA1,
    UART_TX_PA2      = GPIO_PA2,
    UART_TX_PA4      = GPIO_PA4,
    UART_TX_PA5      = GPIO_PA5,
    UART_TX_PA6      = GPIO_PA6,
    UART_TX_PA7      = GPIO_PA7,
    UART_TX_PB0      = GPIO_PB0,
    UART_TX_PB1      = GPIO_PB1,
    UART_TX_NONE_PIN = 0xfff,
} UART_TxPinDef;

/**
 *  @brief  Define UART0 RX pin.
 */
typedef enum
{
    UART_RX_PA0      = GPIO_PA0,
    UART_RX_PA1      = GPIO_PA1,
    UART_RX_PA2      = GPIO_PA2,
    UART_RX_PA4      = GPIO_PA4,
    UART_RX_PA5      = GPIO_PA5,
    UART_RX_PA6      = GPIO_PA6,
    UART_RX_PA7      = GPIO_PA7,
...
typedef enum
{
    UART_RTX_PB1 = GPIO_PB1,
    UART_RTX_NONE_PIN = 0xfff,
} UART_RTxPinDef;

/**
 *  @brief  Define UART CTS pin : A4 A6
 */
typedef enum{
    UART_CTS_PA4 = GPIO_PA4,
    UART_CTS_PA6 = GPIO_PA6,
}UART_CtsPinDef;

/**
 *  @brief  Define UART RTS pin : A5 A7
 */

typedef enum{
    UART_RTS_PA5 = GPIO_PA5,
    UART_RTS_PA7 = GPIO_PA7,
}UART_RtsPinDef;
 ...
 * 
 */
extern unsigned char uart_TxIndex[1];
 ...
 * 
 */
extern unsigned char uart_RxIndex[1];
 ...
 * @return    none
 */
void uart_set_rts(uart_num_e uart_num,unsigned char Enable, UART_RTSModeTypeDef Mode, unsigned char Thresh, unsigned char Invert,  UART_RtsPinDef pin);
/**
 ...
 * @return     none
 */
void uart_set_cts(uart_num_e uart_num,unsigned char Enable, unsigned char Select, UART_CtsPinDef pin);
 ...
 * @return     none
 * @note
 *             - UART0 does not support: PA3, PB2-6;
 */
void uart_gpio_set(uart_num_e uart_num, UART_TxPinDef tx_pin, UART_RxPinDef rx_pin);
