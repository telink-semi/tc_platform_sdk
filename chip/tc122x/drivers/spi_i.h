...
#include "register.h"
  ...
  * @return    none
  */
_attribute_ram_code_sec_ static _always_inline void mspi_wait(void){
 ...
 * @return    none
 */
_attribute_ram_code_sec_ static _always_inline void mspi_high(void){
 ...
 * @return    none
 */
_attribute_ram_code_sec_ static _always_inline void mspi_low(void){
	reg_mspi_ctrl = 0;
}
 ...
 * @return    the spi data.
 */
_attribute_ram_code_sec_ static _always_inline unsigned char mspi_get(void){
 ...
 * @return    none
 */
_attribute_ram_code_sec_ static _always_inline void mspi_write(unsigned char c){
	reg_mspi_data = c;
}
 ...
 * @return    none
 */
_attribute_ram_code_sec_ static _always_inline void mspi_ctrl_write(unsigned char c){
	reg_mspi_ctrl = c;
}
 ...
 * @return    read reault.
 */
_attribute_ram_code_sec_ static _always_inline unsigned char mspi_read(void){
