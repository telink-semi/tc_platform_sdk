...
#define	    sys_tick_per_us   				24
#define		CLOCK_SYS_CLOCK_1250US			(1250 * sys_tick_per_us)

/**
 * @brief   system Timer : 24Mhz, Constant
 */
enum{
	CLOCK_24M_SYS_TIMER_CLK_1S  = sys_tick_per_us*1000*1000,
	CLOCK_24M_SYS_TIMER_CLK_1MS = sys_tick_per_us*1000,
	CLOCK_24M_SYS_TIMER_CLK_1US = sys_tick_per_us,

	CLOCK_SYS_TIMER_CLK_1S  = CLOCK_24M_SYS_TIMER_CLK_1S,
	CLOCK_SYS_TIMER_CLK_1MS = CLOCK_24M_SYS_TIMER_CLK_1MS,
	CLOCK_SYS_TIMER_CLK_1US = CLOCK_24M_SYS_TIMER_CLK_1US,
};
