...
flash_mid_e flash_read_mid(void)
{
	...
	/*
	 * The mids of ZB25WD80B/ZB25WD80C are both 0x14325e,
	 * but the status register of ZB25WD80B are 8 bits, and the status register of ZB25WD80C is 16 bits.
	 * The functions of the two chips are different.
	 * The software detection method is to read SFDP Signature of one byte. If it is 53H, it is ZB25WD80C,
	 * If the SFDP Signature read does not match, it is ZB25WD80B.
	 */
	if(flash_mid == 0x14325e)
	{
