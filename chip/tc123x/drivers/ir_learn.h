...
typedef enum{
    IR_RX_PA0  = GPIO_PA0,
	IR_RX_PA1  = GPIO_PA1, //A0 chip:PA1 always defined as GPIO FUNC, other chip: defined by user.
	IR_RX_PA2  = GPIO_PA2,
	IR_RX_PA4  = GPIO_PA4,
	IR_RX_PA5  = GPIO_PA5,
	IR_RX_PA6  = GPIO_PA6,
...
{
    analog_write(0x07, (analog_read(0x07) & 0xf0) | 0x04);
    analog_write(0x06, (analog_read(0x06) | 0x80));
#if INTERNAL_DEBUG
    analog_write(0x11, (analog_read(0x11) & 0xf0) | 0x0c);//probe rx wave from pc3
#endif
	analog_write(0x06, (analog_read(0x06) | 0x08));
	sleep_us(1);
	analog_write(0x06, (analog_read(0x06) & 0xf7));
}
...
{
    analog_write(0x06, (analog_read(0x06) & 0x7f));
}
