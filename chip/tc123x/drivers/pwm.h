...
/**
 * @brief      Start one or more PWM channels
 * @param[in]  en  - PWM channel selection mask
 * @return     none
 * @note       Multiple channels can be enabled simultaneously using "|" operator.
 *             For example:
 *             - Enable single channel: pwm_multi_start(FLD_PWM0_EN);
 *             - Enable multiple channels: pwm_multi_start(FLD_PWM0_EN | FLD_PWM1_EN);
 *             After enabling, the PWM channels will start outputting waveforms.
 */
