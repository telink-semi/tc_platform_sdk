 ...
 *  If you add a new flash, you need to check the following location and add the corresponding flash model:
    ...
    #8 When adding new flash, you need to confirm the maximum operating current, not greater than 10mA. the larger the load on the LDO of the flash of the TC123X, the lower the VDD_F voltage will be,
	...
	#9 Due to the high power supply voltage of VDDF(greater than 2.0V), the TC123X can only use wide-voltage Flash. Issue:RAP-3.
