 ...
 */
typedef enum{
	FLASH_OTP_0x001000_256B_MID0114325E	=	0x001000,	//001000h-0010FFh
	FLASH_OTP_0x002000_256B_MID0114325E	=	0x002000,	//002000h-0020FFh
	FLASH_OTP_0x003000_256B_MID0114325E	=	0x003000,	//003000h-0030FFh
}mid0114325e_otp_block_e;

/**
 * @brief     the lock area of the Security Registers.
 */
typedef enum{
	FLASH_LOCK_OTP_0x001000_256B_MID0114325E	=	0x0800,	//001000h-0010FFh
	FLASH_LOCK_OTP_0x002000_256B_MID0114325E	=	0x1000,	//002000h-0020FFh
	FLASH_LOCK_OTP_0x003000_256B_MID0114325E	=	0x2000,	//003000h-0030FFh
}mid0114325e_lock_otp_e;
...
typedef enum{
	...
	FLASH_WRITE_STATUS_OTP_MID0114325E	=	0x3800,
 ...
 *						the address of the  Security Registers #3 0x003000-0x0030ff
 ...
 *              If an abnormality occurs, the firmware and user data may be rewritten, resulting in the final Product failure)
 */
void flash_read_otp_mid0114325e(unsigned long addr, unsigned long len, unsigned char* buf);
 ...
 *              If an abnormality occurs, the firmware and user data may be rewritten, resulting in the final Product failure)
 */
void flash_write_otp_mid0114325e(unsigned long addr, unsigned long len, unsigned char *buf);
 ...
 *              If an abnormality occurs, the firmware and user data may be rewritten, resulting in the final Product failure)
 */
void flash_erase_otp_mid0114325e(mid0114325e_otp_block_e addr);
 ...
 *              If an abnormality occurs, the firmware and user data may be rewritten, resulting in the final Product failure)
 */
void flash_lock_otp_mid0114325e(mid0114325e_lock_otp_e data);
#endif