...
typedef enum
{
    ...
    UART1,     /**< Supports NODMA, RX, TX, CTS, RTS and RTX function. */
} uart_num_e;
...
typedef enum
{
    UART_RTX_PA0  = GPIO_PA0,  /** only for UART0. */
    UART_RTX_PA6  = GPIO_PA6,  /** only for UART0. */
    UART1_RTX_PA7 = GPIO_PA7,  /** only for UART1. */
    UART_RTX_PB3  = GPIO_PB3,  /** only for UART0. */
    UART1_RTX_PB4 = GPIO_PB4,  /** only for UART1. */
    UART_RTX_PC0  = GPIO_PC0,  /** only for UART0. */
} UART_RTxPinDef;
