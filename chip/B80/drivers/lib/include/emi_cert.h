...
typedef struct
{
    ...
    RF_ModeTypeDef   rf_mode;            /**< RF mode setting. */
    RF_PowerTypeDef  power_level;        /**< RF power level.  */
} emi_cfg_param_t;
 ...
 */
unsigned int emi_get_pkt_time(unsigned char payload_len, RF_ModeTypeDef rf_mode);
